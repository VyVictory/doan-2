...
function ProfileDetail({ offprofiledetail }) {
    return (
                ...
                <MDBRow className="justify-content-center align-items-center">
                    <MDBCol style={{ backgroundColor: 'none', minWidth: '1000px', padding: '0' }} lg="6">
                        <MDBCard className="mb-3" style={{ borderRadius: '.5rem', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)' }}>
                            <div style={{ width: '100%' }}>
                                <MDBBtn className="btn-close d-flex justify-content-end" color="none" aria-label="Close" onClick={offprofiledetail} style={{ float: 'right' }} />
                            </div>

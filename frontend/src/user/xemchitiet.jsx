                ...
                <div className='d-flex flex-row'>
                    ...
                    <div style={{ width: '23%' }} className='pt-4'>
                        <div style={{ backgroundColor: 'lightgray' }} className="bg-light    p-2 rounded">
                            <div className='p-3 d-flex flex-row d-flex align-items-center border-bottom'>
                                <div >
                            ...
                            <div className=' pl-4 pr-4 pt-2'>
                                <div className='d-flex flex-column items-center'>
                                    ...
                                    <div className='mb-2 d-flex flex-row'>
                                        ...
                                        <input className='border w-20 mr-1 ml-1 pl-5 text-center ' type='number' onChange={(e) => setNumberProduct(parseInt(e.target.value))} value={numberProduct} />
